            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <div className="flex flex-col ml-3 hidden sm:flex border-l-2 pl-3 border-brand-accent/20">
                  <span className="font-heading font-black text-2xl text-white tracking-tight leading-none drop-shadow-sm">{tenant.companyName.split(' ')[0]} <span className="text-brand-accent">{tenant.companyName.split(' ').slice(1).join(' ')}</span></span>
                  <span className="text-sm text-brand-light/60 tracking-wide mt-1">{tenant.tagline}</span>
                </div>
              </div>
            </div>
