              ...
              {tenant.logoUrl ? (
                ...
                <>
                  ...
                  <div className="flex flex-col">
                    <span className="font-heading font-black text-2xl text-brand-dark tracking-tight leading-none bg-clip-text text-transparent bg-gradient-to-r from-brand-dark to-brand-dark/70 drop-shadow-sm">{tenant.companyName.split(' ')[0]} <span className="text-brand-accent">{tenant.companyName.split(' ').slice(1).join(' ')}</span></span>
